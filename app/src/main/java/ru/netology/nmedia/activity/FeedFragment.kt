    ...
    override fun onCreateView(
        ...
        viewModel.newerCount.observe(viewLifecycleOwner) { count ->
            if (count > 0) {
                ...
                val newPostsText = getString(R.string.new_posts).format(count)
        ...
        binding.newPostsButton.setOnClickListener {
            binding.list.smoothScrollToPosition(0) // Скроллим к началу списка
            viewModel.showNewPosts() // Сбрасываем счетчик новых постов
            binding.newPostsButton.isVisible = false // Скрываем плашку
        }
